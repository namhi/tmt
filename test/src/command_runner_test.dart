...
import 'package:tmt/src/command_runner.dart';
...
void main() {
  group('TmtFlutterCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late TmtFlutterCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = TmtFlutterCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = TmtFlutterCliCommandRunner();
